...
![history](../images/beenz/3-3.png)
![history](../images/beenz/3-4.png)  
...
- 설치  
![component_install](../images/beenz/3-5.png)  
- 시스템 변수  
![component_system_variables](../images/beenz/3-6.png)
- 비밀번호 정책
  - `LOW` : 비밀번호 길이만 검증  
...
- 테스트  
![prohibit_word](../images/beenz/3-7.png)  
![prohibit_word](../images/beenz/3-8.png)  
![prohibit_word](../images/beenz/3-9.png)  
![prohibit_word](../images/beenz/3-10.png)  
...
- 역할은 `account_locked` 컬럼이 'Y' 로 설정되어 있다.  
  ![role_account_locked](../images/beenz/3-12.png)
